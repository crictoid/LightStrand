...
public class LightBulmer {
    ...
    public LightBulmer(boolean o, boolean b, String c) {
        on = b ? false : o;
        burntOut = b;
        color = validColor(c);
    }
    ...
    // We have to check to see if the color is set correctly.
    ...
    public static void main(String[] args)
    {
        ...
        // 1. Test Light()
        //*************************************************************************
        LightBulmer light1 = new LightBulmer();
        ...
        //*************************************************************************
        System.out.println("\n2. Test Light(boolean b, boolean o, String c)");
        LightBulmer light2 = new LightBulmer(true, true, "GreeN");
        ...
        //*************************************************************************
        System.out.println("\n4. Test flip()");
        LightBulmer light3 = new LightBulmer();
    ...
    private static void testLight(LightBulmer light, boolean o, boolean b, String c,	String string)	{
    ...
    private static String testLightOn(LightBulmer bulb, boolean o){
    ...
    private static String testLightburntOut(LightBulmer light, boolean b){
    ...
    private static String testLightColor(LightBulmer light, String c){
    ...
    private static String testLightToString(LightBulmer light, String string){
        String output;
